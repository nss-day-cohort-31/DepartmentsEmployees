...
namespace DepartmentsEmployees
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Department accounting2 = new Department { DeptName = "Accounting" };
        ...
        public static void PrintDepartmentReport(string title, List<Department> departments)
        {
            ...
            departments.ForEach(d => Console.WriteLine($"{d.Id}: {d.DeptName}"));
        }
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            Console.WriteLine(title);
            employees.ForEach(e => Console.WriteLine($"{e.Id}: {e.FirstName} {e.LastName}"));
