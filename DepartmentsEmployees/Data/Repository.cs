            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        int idColumnPosition = reader.GetOrdinal("Taco");
        ...
        public List<Employee> GetAllEmployeesWithDepartment()
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"SELECT e.Id AS EmpId,
                                    e.FirstName, 
                                    e.LastName,
                                    d.Id AS DeptId,
                                    d.DeptName
                    ...
                    while (reader.Read())
                    {
                        ...
                        employees.Add(employee);
                        Console.WriteLine($"New employee {employee.FirstName}, {employee.Department.DeptName}");
